...
<x-filament-widgets::widget class="fi-wi-chart">
    ...
    >
        ...
        <div
            ...
            @endif
            class="w-full"
            style="overflow-x: auto; overflow-y: hidden; -webkit-overflow-scrolling: touch; display: block; padding-bottom: 0.5rem;"
        >
            <div class="chart-mobile-wrapper" style="min-width: 650px;">
                <style>
                    /* Prevent Chart.js from capturing touch swipes, allowing native scroll */
